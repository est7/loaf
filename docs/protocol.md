...
| <code>LOCK_HELD_BY</code> | 2 | <code>lock held by PID &#123;pid&#125; (cmd=&#123;cmd&#125;, acquired_at=&#123;acquired_at&#125;)</code> | <code>wait for the holder to finish, or if the PID has exited run `loaf doctor` to clear the stale lock</code> | <code>protocol.md#§11.2</code> |
