...
> **Partial supersession — 2026-07-27:** architecture-deepening A16 的 TUI
> `[d]` alias、`[p] pending` popup、archive hotkey、auto-polling 与
> registry-vs-runtime heartbeat stale promise 已退役。当前 read-only
> surface 使用 `[Enter]` lazy detail、`[a]`
